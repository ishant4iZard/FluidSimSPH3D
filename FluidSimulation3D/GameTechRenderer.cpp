...
GameTechRenderer::GameTechRenderer(GameWorld& world) : OGLRenderer(*Window::GetWindow()), gameWorld(world)	{
	...
	marchingCubesShader = new OGLShader("marchingCubesRendering.vert", "marchingCubesRendering.frag");
...
void NCL::CSC8503::GameTechRenderer::RenderInstancedRenderObject()
{
	...
	int viewLocation = 0;
	int modelLocation = 0;
	int instancedParticlePositionList = 0;
	...
	for (const auto& tempInstancedRenderObject : instancedRenderObjectList)
	{
		...
		if (activeShader != shader) {
			...
			instancedParticlePositionList = glGetUniformLocation(shader->GetProgramID(), "instancedParticlePosition");
...
void NCL::CSC8503::GameTechRenderer::RenderMarchingCubesMesh()
{
	OGLShader* activeShader = nullptr;
	...
	OGLShader* shader = marchingCubesShader;
	...
	glDrawArrays(GL_TRIANGLES, 0, gameWorld.marchingCubestriangleCount );
